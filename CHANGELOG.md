...
- b6016ed: Add a Storybook preset that stops the CSS minifier downleveling `light-dark()`
...
- 9fa342c: Replace semantic-release with changesets for release management.
...
- try to run directly ([f4e37b8](https://github.com/Neovici/cfg/commit/f4e37b8a619a42def7fc51ace4a0fbd5dc107233))
- update workflow to use Neovici's forge.yml ([329f3b6](https://github.com/Neovici/cfg/commit/329f3b6e2f761e9ac78b31612606eaeeb555fdb6))
...
## [2.5.1](https://github.com/Neovici/cfg/compare/v2.5.0...v2.5.1) (2025-08-05)
...
## [2.5.1](https://github.com/Neovici/cfg/compare/v2.5.0...v2.5.1) (2025-07-27)
